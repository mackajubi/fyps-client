...
@Component({
  ...
  templateUrl: './requirements-tools-page.component.html',
  styleUrls: ['./requirements-tools-page.component.css']
})
export class RequirementsToolsPageComponent implements OnInit {
